...
//		obj1.
		...
		for(int i=0; i<stdArray.length; i++) {
			stdArray[i] = new Student()/*
										 * {
										 * 
										 * @Override public void setGrade(int grade) { System.out.println("학년 " +3); } }
										 */;
		}
...
//		toString()=Person [name=null, age=15, gender=여]]
		...
		Student yh = new Student("김영희", '여', 20,
				1)/*
					 * {
					 * 
					 * @Override public void setGrade(int grade) { System.out.println("학년 지정함"); } }
					 */;
